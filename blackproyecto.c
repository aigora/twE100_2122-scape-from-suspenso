...
int Blackjack(int nivel,int *intentos,int *intentosult);
int main(){
    int intentos=0;
    int intentosult;
...
do{
    ...
    if(nivel==1){printf("cinco intentos");} if(nivel==2){printf("tres intentos");} if(nivel==3){printf("un intento");}printf(" para ganar.\n");
    ...
    *intentos=*intentos+intentosrealizados;
